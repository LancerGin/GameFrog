...
var Engine = (function(global) {
    ...
    /* 处理游戏重置的逻辑。它只会被 init()函数调用一次。
     */
    function reset() {
        /* 给‘再玩一次’按钮绑定单击事件，点击后调用函数 playAgain()重置游戏，
         * 向 result()传参 ‘off’ 以隐藏游戏结束的画面
         */
    ...
    /* 紧接着加载需要用来绘制游戏关卡的图片。然后把 init 方法设置为回调函数。
